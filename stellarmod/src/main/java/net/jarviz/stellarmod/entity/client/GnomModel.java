...
import net.jarviz.stellarmod.stellarmod;
...
public class GnomModel extends GeoModel<GnomEntity> {
    ...
    public ResourceLocation getModelResource(GnomEntity animatable) {
        return new ResourceLocation(stellarmod.MOD_ID, "geo/gnom.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GnomEntity animatable) {
        return new ResourceLocation(stellarmod.MOD_ID, "textures/entity/gnom.png");
    }

    @Override
    public ResourceLocation getAnimationResource(GnomEntity animatable) {
        return new ResourceLocation(stellarmod.MOD_ID, "animations/gnom.animation.json");
    }
}
